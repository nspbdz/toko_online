...
<div class="container">
      ...
      <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
              ...
              <img src="{{ url('storage/'.$slide->foto) }}" width="300" height="400" alt="" title="" />
          ...
          <img src="{{ url('storage/'.$slide->foto) }}" alt="" title="" />
              <!-- <img src="{{ \Storage::url($slide->foto) }}" class="d-block w-100" alt="..."> -->
              <div class="carousel-caption d-none d-md-block">
                <h5>{{ $slide->caption_title }}</h5>
                <p>{{ $slide->caption_content }}</p>
  ...
  <div class="row mt-4">
    <div class="col col-md-12 col-sm-12 mb-4">
      <h2 class="text-center">Kategori Produks</h2>
    </div>
    @foreach($itemkategori as $kategori)
    <!-- kategori pertama -->
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('kategori/'.$kategori->slug_kategori) }}" width="150" height="200">
          @if($kategori->foto != null)
          <img src="{{ url('storage/'.$kategori->foto) }}" alt="" title="" />
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('produk/'.$produk->slug_produk) }}">
          @if($produk->foto != null)
          <!-- {{ asset('images/bag.jpg') }} -->
          <img src="{{ url('storage/'.$produk->foto) }}" alt="" title="" width="150" height="200"/>
          <!-- <img  alt="{{ $produk->nama_produk }}" class="card-img-top"> -->
  ...
  <div class="row mt-4">
    <div class="col">
      ...
      <p>
      Toko online terbaru siap untuk berjualan dengan segera dengan klik langsung transaksi
    </p>
      <p class="text-center">
